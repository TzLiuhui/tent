    ...
    function generateResource(id, array) {
        ...
        for (var i in oneMenu) {
            ...
            if (twoMenu.length > 0) {
                ...
                menus += '<a href="#' + oneMenu[i].url + '" class="nav-link" ><i class="' + oneMenu[i].icon + ' nav-icon "></i>'
                ...
                for (var j in twoMenu) {
                    ...
                    menus += '<a href="#' + twoMenu[j].url + '" class="nav-link" ><i class="' + twoMenu[j].icon + ' nav-icon ml-3"></i>'
